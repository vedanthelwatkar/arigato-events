...
const ServiceDetailPage = () => {
  ...
  const serviceDetails = {
    "event-concierge": {
      ...
      description: "End-to-end event planning and management services for private and corporate occasions.",
      fullDescription:
    ...
    "content-creation": {
      ...
      description: "Premium photography and videography services to capture your most precious moments.",
      fullDescription:
    ...
    "private-jets": {
      ...
      description: "Luxury private aviation services for seamless travel experiences.",
      fullDescription:
      ...
      <div className="min-h-[80vh] flex items-center justify-center">
        <div className="w-full px-6 py-16 flex justify-center">
          <div className="max-w-md text-center">
            <h1 className="text-3xl font-serif text-primary mb-4">Service Not Found</h1>
            <p className="text-primary/70 mb-8">The service you're looking for doesn't exist or has been moved.</p>
      ...
      <section className="pt-32 pb-16 md:pt-40 md:pb-24">
        <div className="w-full px-6 flex justify-center">
          <motion.div
            ...
            className="max-w-3xl"
          >
            <Link to="/services" className="inline-flex items-center text-primary/70 hover:text-primary mb-6">
              <ArrowLeft size={16} className="mr-2" />
              Back to Services
            </Link>
            <h1 className="text-4xl md:text-5xl font-serif mb-6 text-primary">{service.title}</h1>
        ...
        <div className="w-full px-6 flex justify-center">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-6xl">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl font-serif mb-6 text-primary">About This Service</h2>
      ...
      <section className="py-16 md:py-24">
        <div className="w-full px-6 flex justify-center">
          <div className="text-center max-w-3xl">
            ...
            >
              Contact us today to discuss how we can tailor this service to your specific needs and create an
